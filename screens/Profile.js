...
import { logoutFetch } from "../slice/userSlice";
const userDetails = {
  name: "John Pearson",
      ...
      <View style={{ backgroundColor: "white", height: "100%" }}>
        <View style={{ height: "20%", marginTop: "5%", width: "90%", marginLeft: "5%", position: "relative" }}>
          <Image
            ...
            style={{ resizeMode: "cover", flex: 1, width: "100%", position: "relative", borderRadius: 20 }}
          />
          <View style={{ flexDirection: "row", position: "absolute", gap: 20 }}>
            ...
            <View style={{ top: "15%" }}>
              <Text style={{ color: "white", fontSize: 24 }}>{userDetails.name}</Text>
              <Text style={{ color: "white", fontSize: 12 }}>{userDetails.email}</Text>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity
          style={{ width: "90%", marginLeft: "5%", marginTop: "5%", borderBottomColor: "#E6E6E6", borderBottomWidth: 1, paddingBottom: "3%" }}
        ...
        <TouchableOpacity style={{ width: "90%", marginLeft: "5%", marginTop: "5%" }} onPress={() => setlogoutModalVisible(true)}>
          <View style={{}}>
