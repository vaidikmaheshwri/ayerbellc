  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        value={email} 
        onChangeText={(txt) => setEmail(txt)} style={styles.email} />
        </View>
        <View style={styles.passwordSection}>
            <Image source={require('../assets/passwordLogo.png')}
            style={styles.passowordLogo}/>
          <TextInput
          ...
          />
          <Image source={require('../assets/bxs_show.png')}
        ...
        <View style={styles.forgotBtnSection}>
           ...
           onPress={()=>{
            if(radioBtn==1){
             ...
             <View style={styles.radioBtnSection}>
              ...
              {radioBtn==2 ? <View style={styles.radiobtnbg}></View> :null}
              </View>
          ...
          <TouchableOpacity
          onPress={()=>navigation.navigate('forgotpswd')}
